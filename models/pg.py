...
class Pgrooms(models.Model):
    ...
    room_type = fields.Selection([('single','Single Sharing'),('double','Double Sharing'),('tripe','Triple Sharing'),('four','Four Sharing'),('six','Six Sharing')],required='no copy')
    ac_nonac = fields.Selection([('ac','Ac'),('non_ac','Non Ac')],string="Ac/Non-Ac" , required='no copy')
